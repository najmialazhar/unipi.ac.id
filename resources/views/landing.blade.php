...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('iportofolio/assets/img/logo/unipi bg putih.png') }}" rel="icon">
  <link href="{{ asset('iportofolio/assets/img/logo/unipi.png') }}" rel="apple-touch-icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('iportofolio/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ asset('iportofolio/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
  <link href="{{ asset('iportofolio/assets/vendor/aos/aos.css') }}" rel="stylesheet">
  <link href="{{ asset('iportofolio/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
  <link href="{{ asset('iportofolio/assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">

  <!-- Main CSS File -->
  <link href="{{ asset('iportofolio/assets/css/main.css') }}" rel="stylesheet">
...
<body class="index-page">
  ...
  <header id="header" class="header dark-background d-flex flex-column">
    ...
    <div class="profile-img">
      <img src="{{ asset('iportofolio/assets/img/logo/unipi bg putih.png') }}" alt="Logo Universitas Pancasila" class="img-fluid">
    </div>

    <a href="index.html" class="logo d-flex align-items-center justify-content-center">
      <!-- Uncomment the line below if you also wish to use an image logo -->
      <!-- <img src="{{ asset('iportofolio/assets/img/logo.png') }}" alt=""> -->
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src="{{ asset('iportofolio/assets/img/kampus/GD UNIPI DEPAN 1.jpeg') }}" alt="" data-aos="fade-in" class="">
        ...
        <div class="row gy-4 align-items-center">
          ...
          <aside class="col-lg-5">
            <div class="welcome-unipi-photo">
              <img src="{{ asset('iportofolio/assets/img/kampus/droneunipi1.jpeg') }}" alt="Foto sambutan" class="img-fluid">
            </div>
          </aside>
        </div>
      </div>
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-kampus">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/kampus/GD UNIPI DEPAN 1.jpeg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Kampus</h4>
                  <a href="{{ asset('iportofolio/assets/img/kampus/GD UNIPI DEPAN 1.jpeg') }}" title="Gedung UNIPI" data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-staff">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/portfolio/product-1.jpg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Staff</h4>
                  <a href="{{ asset('iportofolio/assets/img/portfolio/product-1.jpg') }}" title="" data-gallery="portfolio-gallery-product" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-other">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/portfolio/branding-1.jpg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Other</h4>
                  <a href="{{ asset('iportofolio/assets/img/portfolio/branding-1.jpg') }}" title="" data-gallery="portfolio-gallery-branding" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-other">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/portfolio/books-1.jpg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Other</h4>
                  <a href="{{ asset('iportofolio/assets/img/portfolio/books-1.jpg') }}" title="" data-gallery="portfolio-gallery-book" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-kampus">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/kampus/droneunipi1.jpeg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Kampus</h4>
                  <a href="{{ asset('iportofolio/assets/img/kampus/droneunipi1.jpeg') }}" title="" data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-staff">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/portfolio/product-2.jpg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Staff</h4>
                  <a href="{{ asset('iportofolio/assets/img/portfolio/product-2.jpg') }}" title="" data-gallery="portfolio-gallery-product" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-other">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/portfolio/branding-2.jpg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Other</h4>
                  <a href="{{ asset('iportofolio/assets/img/portfolio/branding-2.jpg') }}" title="" data-gallery="portfolio-gallery-branding" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-other">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/portfolio/books-2.jpg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Other</h4>
                  <a href="{{ asset('iportofolio/assets/img/portfolio/books-2.jpg') }}" title="" data-gallery="portfolio-gallery-book" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-kampus">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/kampus/droneunipi2.jpeg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Kampus</h4>
                  <a href="{{ asset('iportofolio/assets/img/kampus/droneunipi2.jpeg') }}" title="" data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-staff">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/portfolio/product-3.jpg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Staff</h4>
                  <a href="{{ asset('iportofolio/assets/img/portfolio/product-3.jpg') }}" title="" data-gallery="portfolio-gallery-product" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-other">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/portfolio/branding-3.jpg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Other</h4>
                  <a href="{{ asset('iportofolio/assets/img/portfolio/branding-3.jpg') }}" title="" data-gallery="portfolio-gallery-branding" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item category-other">
              <div class="portfolio-content h-100">
                <img src="{{ asset('iportofolio/assets/img/portfolio/books-3.jpg') }}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>Other</h4>
                  <a href="{{ asset('iportofolio/assets/img/portfolio/books-3.jpg') }}" title="" data-gallery="portfolio-gallery-book" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Portfolio Item -->
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="{{ asset('iportofolio/assets/img/testimonials/testimonials-1.jpg') }}" class="testimonial-img" alt="">
                <h3>Rizky Maulana</h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="{{ asset('iportofolio/assets/img/testimonials/testimonials-2.jpg') }}" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="{{ asset('iportofolio/assets/img/testimonials/testimonials-3.jpg') }}" class="testimonial-img" alt="">
                <h3>Fajar Ramdani</h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="{{ asset('iportofolio/assets/img/testimonials/testimonials-4.jpg') }}" class="testimonial-img" alt="">
                <h3>Intan Permata</h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="{{ asset('iportofolio/assets/img/testimonials/testimonials-5.jpg') }}" class="testimonial-img" alt="">
                <h3>Ahmad Fauzi</h3>
  ...
  <!-- Vendor JS Files -->
  <script src="{{ asset('iportofolio/assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
  <script src="{{ asset('iportofolio/assets/vendor/php-email-form/validate.js') }}"></script>
  <script src="{{ asset('iportofolio/assets/vendor/aos/aos.js') }}"></script>
  <script src="{{ asset('iportofolio/assets/vendor/typed.js/typed.umd.js') }}"></script>
  <script src="{{ asset('iportofolio/assets/vendor/purecounter/purecounter_vanilla.js') }}"></script>
  <script src="{{ asset('iportofolio/assets/vendor/waypoints/noframework.waypoints.js') }}"></script>
  <script src="{{ asset('iportofolio/assets/vendor/glightbox/js/glightbox.min.js') }}"></script>
  <script src="{{ asset('iportofolio/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js') }}"></script>
  <script src="{{ asset('iportofolio/assets/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>
  <script src="{{ asset('iportofolio/assets/vendor/swiper/swiper-bundle.min.js') }}"></script>

  <!-- Main JS File -->
  <script src="{{ asset('iportofolio/assets/js/main.js') }}"></script>
